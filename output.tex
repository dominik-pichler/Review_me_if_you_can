...
\lstdefinelanguage{Cypher}{
  keywords={MATCH, RETURN, WHERE, WITH, ORDER, BY, AS, CASE, WHEN, THEN, ELSE, END},
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.15}}@{}}\toprule\noalign{}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{drawings/TransE_Goal.png}
    \caption{Goal of TransE}
\end{figure}
...
trained/learned the following way:
  ...
  \begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{drawings/TransE_training.png}
    \caption{Training of TransE}
  \end{figure}\end{
