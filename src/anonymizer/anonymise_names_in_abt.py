...
from src.credentials import AH_DB_NAME,AH_HOSTNAME,AH_PASSWORD,AH_USERNAME,AH_PORT
...
def anonymize_names(table_name, name_column):
    ...
    try:
        ...
        select_query = f"SELECT booking_id, {name_column} FROM {table_name};"
        ...
        for row in tqdm(rows):
            ...
            update_query = f"UPDATE {table_name} SET {name_column} = %s WHERE booking_id = %s;"
